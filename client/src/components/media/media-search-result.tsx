...
const MediaSearchResult = (
    ...
    return (
        <Card
            isBlurred
            className="absolute z-30 pt-4 bg-background/60 bg-foreground flex flex-col items-center w-[82vw] top-16 h-[88vh] m-4 rounded-xl ring-1 left-[50%] translate-x-[-50%] overflow-scroll">
            <div

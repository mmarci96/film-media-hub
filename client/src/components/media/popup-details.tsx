...
import GenreList from "@/components/media-genres";
...
const PopupDetails: React.FC<PopupDetailsProps> = ({ mediaDetails, media }) => {
    return (<div className="flex items-center justify-start">
        ...
        <div className="flex flex-col items-start gap-2 mx-auto ml-8">
            <Chip
                className="p-2 h-12 bg-90/100 shadow-xl mx-1 rounded-lg flex items-center">
                <p
                    className="text-lg flex">
                    <FaStar color="yellow" className="m-1 mr-4" />
            ...
            <Chip
                ...
                <p
                    ...
                    Release:
                    {mediaDetails?.release_date ?? "N/A"}</p>

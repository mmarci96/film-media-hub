            ...
            <section className="flex flex-col items-center justify-center ">
                {isAuthenticated ?
                    <div
                        ...
                        style={{
                            backgroundImage: `linear-gradient(to bottom, rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 1)), url(./bg-cover.jpg)`, objectFit: 'fill'
                        }}
                    ...
                    >
                        ...
                        >
                            <CardHeader className="bg-background">
                                <h1 className="text-xl my-2 font-bold tracking-wider"> Welcome to FilmHub!</h1>
                            </CardHeader>
                                ...
                                <div className="flex justify-evenly gap-2 flex-wrap sm:flex-box">
                                    {topPlaying.length >= 1 &&
                                        topPlaying.map((mediaItem) => (
                                            <div key={mediaItem.id} className="w-[280px]" >
                                                <MediaCard media={mediaItem} mediaType="movie" />
                                            </div>
                                        ))}
                                </div>
                            </CardBody>
